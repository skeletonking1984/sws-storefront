 ...
 *
 * Reads data/etsy-reviews-raw.json (100 most recent StreamWidgetShop Etsy
 ...
 * sync). Writes app/data/etsy-reviews.json, grouped per Shopify product
 * handle, for the PDP to render real per-product reviews instead of the
 * shop-wide sample.
 *
...
function main() {
  ...
  const output = {
    ...
    sourceNote:
      ...
      'matches are kept, see scripts/build-etsy-reviews.mjs.',
    products,
  };
