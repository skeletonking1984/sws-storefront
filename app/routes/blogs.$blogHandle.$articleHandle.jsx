...
/*
 * Preloaded per route, not in root.jsx: only this page and the product
 * description paint in Space Grotesk, so every other page would pay ~22KB for
 * a face it never renders. See app/lib/articleFont.js.
 *
